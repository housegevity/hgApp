 ...
 *
 * <pre>
 *   hgAppDev = angular.module('hgAppDev', ['hgApp', 'ngMockE2E']);
 *   hgAppDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('hgApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('hgApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('hgApplicationModule'));
   *
   *
