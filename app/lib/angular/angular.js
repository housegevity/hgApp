 ...
 * 
 * <pre>
 * var hgApp = angular.module('hgApp', []);
 * hgApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://hgApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://hgApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('hgApp', []).config(function($sceDelegateProvider) {
 ...
 *        'http://hgApp.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="hgAppController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("hgAppController", function hgAppController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('hgAppWithSceDisabledhgApp', []).config(function($sceProvider) {
